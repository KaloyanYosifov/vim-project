...
command! -nargs=0 -bar LockProjectDirectory
\ call project#config#set_directory_lock(1)

command! -nargs=0 -bar UnlockProjectDirectory
\ call project#config#set_directory_lock(0)
